...
func bicTransportScope(ref udistributionReference) types.BICTransportScope {
...
func newBICLocationReference(ref udistributionReference) types.BICLocationReference {
